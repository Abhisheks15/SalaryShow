...
namespace WebAppMVCd48.Controllers
{
    public class SalariesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PayBand,BasicSalary,Hra,Ta,Da,Tds")] Salary salary)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PayBand,BasicSalary,Hra,Ta,Da,Tds")] Salary salary)
        {
